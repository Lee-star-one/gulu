...
describe('Col', () => {
  ...
  it('接收 pc 属性',()=>{
    ...
    expect(element.classList.contains('offset-pc-10')).to.eq(true)
    div.remove()
    vm.$destroy()
  })
  it('接收 ipad 属性',()=>{
    ...
    const element=vm.$el
    expect(element.classList.contains('col-ipad-10')).to.eq(true)
    expect(element.classList.contains('offset-ipad-10')).to.eq(true)
    div.remove()
    vm.$destroy()
  })
  it('接收 narrowPc 属性',()=>{
    ...
    expect(element.classList.contains('offset-narrow-pc-10')).to.eq(true)
    div.remove()
    vm.$destroy()
  })
  it('接收 widePc 属性',()=>{
    ...
    expect(element.classList.contains('offset-wide-pc-10')).to.eq(true)
    div.remove()
    vm.$destroy()
  })
  it('接收 ipad 属性',()=>{
